...
| `Polynomial` | `P`        | `List[Point]`                        | Returns the minimal polynomial that goes through all the points.                                                                                                              |
| `Parametric` | `A`        | `List[Point]`                        | Returns the minimal parametric curve that gives the given points when t is equal to 0, 1, 2, etc.                                                                             |
